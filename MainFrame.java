...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        mainTabbedPane.addTab("Student Enrollment", createModulePanel(
    ...
    private JMenuBar createMenuBar() {
        ...
        JMenuItem summaryReportItem = new JMenuItem("Summary Reports & Charts");
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel subtitleLabel = new JLabel("Integrated Academic Analytics, Exam Scheduling & Relative Grading Engine");
    ...
    private JPanel createQuickToolBar() {
        ...
        JButton reportsBtn = createStyledButton("Summary Reports", new Color(40, 120, 180));
    ...
    private JPanel createGradePanel() {
        ...
        // Add extra button to bottom panel specifically for Grade Module
    ...
    private void showAboutDialog() {
        String msg = "<html><body style='width: 340px; padding: 10px; font-family: sans-serif;'>"
                ...
                + "<li>Branch & Section Grouped Analytics</li>"
                + "<li>Custom Graphics2D Visual Grade Distribution Charts</li>"
                + "<li>Real-time TableRowSorter & RowFilter Search</li>"
