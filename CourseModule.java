...
public class CourseModule {
    ...
    private void preloadSampleData() {
        addCourseInternal(new Course("CS101", "Introduction to Computer Science", 4));
        addCourseInternal(new Course("CS201", "Data Structures & Algorithms", 4));
        addCourseInternal(new Course("EC101", "Digital Electronics", 3));
        addCourseInternal(new Course("IT301", "Database Management Systems", 4));
        addCourseInternal(new Course("MA102", "Engineering Mathematics II", 3));
        addCourseInternal(new Course("ME101", "Thermodynamics", 3));
    }
