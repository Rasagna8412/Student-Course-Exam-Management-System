...
public class StudentModule {
    ...
    private void preloadSampleData() {
        addStudentInternal(new Student("STU1001", "Alice Johnson", "CSE", "A", "CS101"));
        addStudentInternal(new Student("STU1002", "Bob Smith", "CSE", "A", "CS101"));
        addStudentInternal(new Student("STU1003", "Charlie Brown", "CSE", "B", "CS201"));
        addStudentInternal(new Student("STU1004", "Diana Prince", "ECE", "A", "EC101"));
        addStudentInternal(new Student("STU1005", "Evan Wright", "ECE", "B", "EC101"));
        addStudentInternal(new Student("STU1006", "Fiona Gallagher", "IT", "A", "IT301"));
        addStudentInternal(new Student("STU1007", "George Clark", "IT", "B", "IT301"));
        addStudentInternal(new Student("STU1008", "Hannah Abbott", "ME", "A", "ME101"));
        addStudentInternal(new Student("STU1009", "Ian Malcolm", "CSE", "A", "CS101"));
        addStudentInternal(new Student("STU1010", "Julia Roberts", "CSE", "B", "CS201"));
    }
